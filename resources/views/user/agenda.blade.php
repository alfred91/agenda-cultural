...
<div class="py-4 bg-gradient-to-r from-cyan-600 to-blue-500">
    <div class="mb-8 text-center">
        <h1 class=" mt-12 text-6xl font-bold text-white dark:text-white">agenda</h1>
    </div>
    ...
    <div class="flex justify-center mb-0">
        <div class="w-full sm:w-2/3 lg:w-1/2 xl:w-1/3">
            <div class="flex justify-between items-center">
                <a href="{{ route('user.agenda') }}" class="text-white hover:underline">Todos</a>
                <a href="{{ route('user.agenda', 'week') }}" class="text-white hover:underline">Esta Semana</a>
                <a href="{{ route('user.agenda', 'month') }}" class="text-white hover:underline">Este Mes</a>
            </div>
        </div>
    </div>
</div>
